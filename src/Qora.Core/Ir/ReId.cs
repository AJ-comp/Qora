...
/// position — such as <see cref="Passes.Monomorphizer"/> stamping one generic body into several
/// specializations — would otherwise carry the source Ids along (the copies are made with <c>with</c>,
